  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-blue-50 to-teal-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block order-2 lg:order-1">
          <div className="relative">
            <img
              ...
              alt="Beautiful coral reef with colorful fish"
              className="rounded-2xl shadow-2xl w-full h-[600px] object-cover"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent rounded-2xl"></div>
            <div className="absolute bottom-8 left-8 right-8 text-white">
              <h2 className="text-3xl font-bold mb-4">
                Welcome Back to Green Aqua Land
              </h2>
              <div className="space-y-3">
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full mr-3"></div>
                  <span>Access your aquarium wishlist</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full mr-3"></div>
                  <span>Track your orders & deliveries</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-cyan-400 rounded-full mr-3"></div>
        ...
        {/* Right Side - Form */}
        <div className="bg-white rounded-2xl shadow-2xl p-8 lg:p-12 border border-gray-100 order-1 lg:order-2">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Sign in to your Green Aqua Land account
            </p>
          </div>
